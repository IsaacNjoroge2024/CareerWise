...
const QuestionCard: React.FC<QuestionCardProps> = ({ questionNumber, questionText, options }) => {
    return (
        <section className="flex flex-col grow shrink-0 pb-11 bg-indigo-500 basis-0 rounded-[41px] w-fit max-md:max-w-full">
            ...
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/e17543c53cb4757afbcc2bf54998ce1f376c395c7b546a1a6ea72cd9bcdfcb04?placeholderIfAbsent=true&apiKey=3c8be96a4c1e410f8809634ba899bb87" alt="" className="object-contain shrink-0 self-start mt-36 max-w-full aspect-[0.88] w-[132px] max-md:mt-10" />
        </section>
    );
};
